          ...
          <div ref={certRef} id="certificate-pdf-node" className="bg-gradient-to-b from-[#0b1120] via-[#090e1a] to-[#0b1120] p-8 md:p-12 rounded-3xl border-4 border-double border-amber-500/50 shadow-2xl relative print:border-amber-600 print:bg-white">
            ...
            <div className="text-center space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6 items-center text-left border-t border-slate-800 print:border-slate-300">
                ...
                {/* Right: Rohan Mishra - Founder & CEO, SkillSphere Enterprise */}
                <div className="text-center md:text-right space-y-1">
                  {/* 1. Above Horizontal Rule: Cursive SVG Signature Mark */}
                  <div className="flex justify-center md:justify-end items-center h-10 select-none -rotate-2">
                  ...
                  {/* 2. Standard Authority Baseline Divider */}
                  <div className="w-52 h-[1px] bg-slate-700 mx-auto md:ml-auto md:mr-0 my-1.5" />

                  {/* 3. Signatory Details & Cryptographic Verification Badge */}
                  <div className="text-xs font-bold text-slate-200 tracking-wider print:text-black">Rohan Mishra</div>
                  <div className="text-[10px] text-slate-400 font-medium print:text-slate-600">Founder &amp; CEO, SkillSphere Enterprise</div>

                  <div className="inline-flex items-center gap-1.5 mt-2 px-2.5 py-0.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-[10px] text-emerald-400 font-medium print:border-emerald-600">
