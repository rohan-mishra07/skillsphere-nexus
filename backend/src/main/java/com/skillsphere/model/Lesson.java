...
public class Lesson {
    ...
    public Lesson(Long id, java.util.UUID courseId, String title, String videoUrl, String notesContent, String pdfUrl, int durationMinutes, int sequenceOrder) {
        this.id = id;
    ...
    public static class LessonBuilder {
        ...
        public LessonBuilder courseId(java.util.UUID courseId) { this.courseId = courseId; return this; }
