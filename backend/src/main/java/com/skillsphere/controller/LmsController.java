...
import com.skillsphere.dto.ApiResponse;
...
public class LmsController {
    ...
    public ResponseEntity<Certificate> issueCertificate(@RequestParam Long userId, @RequestParam String userName, @RequestParam Long courseId) {
